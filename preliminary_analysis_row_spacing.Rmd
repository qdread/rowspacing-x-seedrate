...
- Localseed has more severe disease than Asgrow.
- Row spacing of 30 had the lowest disease severity, but 15 row spacing had the highest. 7.5 was in the middle. However the differences were relatively small especially compared to the difference between the two seed sources.
- 80K seeding rate had the highest disease severity. Again this difference was relatively smaller than the difference between the two seed sources.
- There were some interactions between the different treatments for disease severity, but they are difficult to interpret biologically and I suspect they may be due to random chance. I would not want to interpret them too much at this point, and would rather wait for more years of data to see what interaction effects we observe in the full dataset.

## Yield

- Yield results are straightforward and follow expectations, with no interactions observed.
- Localseed has higher yield than Asgrow.
- Yield decreased as spacing increased.
- Yield increased as seeding rate increased.
- The baseline soil CFU levels didn't seem to affect severity or yield that much, so I excluded them from the final model.
...
#### Severity by seed type x row spacing
...
#### Severity by seed type x seeding rate
...
#### Severity by row spacing x seeding rate
...
#### Severity by three-way interaction of all treatments
